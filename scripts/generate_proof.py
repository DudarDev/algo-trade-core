...
def create_terminal_screenshot(filename, lines, title="Terminal - ai-bot"):
    ...
    for line in lines:
        ...
        if "BUY" in line:
            color = green_color
        elif "SELL" in line and "🤑" in line:
            color = green_color
        elif "SELL" in line:
            color = red_color
        elif "AI" in line or "Brain" in line:
            color = purple_color
        elif "Database" in line or "Баланс" in line:
            color = blue_color
        elif "💤" in line or "wait" in line:
            color = yellow_color
        elif "root@" in line:
            color = green_color  # Командний рядок
...
if __name__ == "__main__":
    ...
    create_terminal_screenshot(
        "proof_success_marketing.png", logs_marketing, "Terminal - Daily Profit Log"
    )
