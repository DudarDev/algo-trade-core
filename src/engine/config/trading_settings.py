...
class TradingSettings(BaseSettings):
    ...
    min_ai_confidence: float = Field(0.24, ge=0.1, le=1.0, description="Minimum AI confidence")
    
    CONFIDENCE_THRESHOLD: float = Field(0.24, ge=0.1, le=1.0, description="Minimum AI confidence")
