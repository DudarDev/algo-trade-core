...
class TradingSettings(BaseSettings):
    ...
    min_ai_confidence: float = Field(0.30, ge=0.0, le=1.0, description="Minimum AI confidence")
    CONFIDENCE_THRESHOLD: float = Field(0.35, ge=0.0, le=1.0, description="Minimum AI confidence")
